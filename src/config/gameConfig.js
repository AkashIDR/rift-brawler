...
export const WEAPON = {
  ORBIT_X: 38,            // local px — outer horizontal extreme of the half-ellipse swivel
  ORBIT_Y_UP: 9.5,        // local px — vertical rise when aiming up
  ORBIT_Y_DOWN: 12,       // local px — vertical drop when aiming down (deeper bottom half)
